...
public class Dijkstra {
	...
	private final Logger log = LoggerFactory.getLogger(Dijkstra.class);
	
	public Dijkstra() {
	}

	public Caminho findSinglePath(RestNode originNode, RestNode destinationNode) {
		...
		Caminho caminho = new Caminho(weight, path);
	...
	private String createJsonPayload(RestNode destinationNode) {
		...
		relationships.addProperty(TYPE, Tipo.LEADS_TO.toString());
